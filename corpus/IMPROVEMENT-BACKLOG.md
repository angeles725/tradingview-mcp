...
| 7 | algorithm | `decide.py:97`; `quant.py:183-201` | `vr>1.0` hard threshold, no significance; overlapping VR biased | Lo–MacKinlay heteroskedasticity-robust z (M2), require significance | M / med |
